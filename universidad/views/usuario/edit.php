...
<body>
  ...
  <div class='content'>
    ...
    <form action="index.php?controller=usuario&action=edit&id=<?php echo $usuario['id']; ?>" method="post">
      ...
      <select id="tipo" name="tipo">
        ...
        <option value="administrador" <?php echo $usuario['tipo'] == 'administrador' ? 'selected' : ''; ?>>Administrador
        </option>
      </select>
